  ...
  return (
    <div className="detail-overview">
      ...
      <section className="detail-overview__section detail-overview__section--details">
        <div className="detail-overview__meta detail-overview__meta--comparison">
          <div className="detail-overview__meta-row">
            <strong>{exchangeRoute}</strong>
          </div>
        </div>

        <div className={calc.canExchange ? "detail-explanation-card" : "detail-explanation-card is-blocked"}>
